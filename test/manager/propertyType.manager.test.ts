    ...
    context("Valid types", () => {
      context("Valid number type", () => {
        it("Should create property", async () => {
          ...
          expect(createdProperty).to.have.property("isUnique", propertyNumberExample.isUnique);
          expect(createdProperty).to.have.property("index", propertyNumberExample.index);
          expect(createdProperty).to.have.property("required", propertyNumberExample.required);
      ...
      context("Valid string type", () => {
        it("Should create property", async () => {
          ...
          expect(createdProperty).to.have.property("isUnique", propertyStringExample.isUnique);
          expect(createdProperty).to.have.property("index", propertyStringExample.index);
          expect(createdProperty).to.have.property("required", propertyStringExample.required);
          expect(JSON.stringify(createdProperty.createdAt)).to.equals(
      ...
      context("Valid date type", () => {
        it("Should create property", async () => {
          ...
          expect(createdProperty).to.have.property("isUnique", propertyDateExample.isUnique);
          expect(createdProperty).to.have.property("index", propertyDateExample.index);
          expect(createdProperty).to.have.property("required", propertyDateExample.required);
          expect(JSON.stringify(createdProperty.createdAt)).to.equals(
      ...
      context("Valid boolean type", () => {
        it("Should create property", async () => {
          ...
          expect(createdProperty).to.have.property("isUnique", propertyBooleanExample.isUnique);
          expect(createdProperty).to.have.property("index", propertyBooleanExample.index);
          expect(createdProperty).to.have.property("required", propertyBooleanExample.required);
          expect(JSON.stringify(createdProperty.createdAt)).to.equals(
      ...
      context("Valid objectId type", () => {
        ...
        it("Should create property", async () => {
          ...
          expect(String(createdProperty.defaultValue)).to.be.equals(String(schema._id));
          expect(createdProperty).to.have.property(
            "propertyRef",
          ...
          expect(JSON.stringify(createdProperty.enum)).to.equals(JSON.stringify([schema._id]));
          expect(createdProperty).to.have.property("isUnique", propertyObjectIdExample.isUnique);
          expect(createdProperty).to.have.property("index", propertyObjectIdExample.index);
          expect(createdProperty).to.have.property("required", propertyObjectIdExample.required);
          expect(JSON.stringify(createdProperty.createdAt)).to.equals(
            ...
            context("Invalid default value", () => {
              it("Should throw an InvalidValueInPropertyError", async () => {
                ...
                try {
                  ...
                  expect(functionError instanceof InvalidValueInPropertyError)
                    .to.be.true;
                }
              });
            });
